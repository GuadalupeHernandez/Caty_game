...
PLAYER_ANIMATION_FPS = 5.0 
GRAVITY = Vec[0, 600] 
JUMP_VEL = Vec[0, -300] 
DEATH_VELOCITY = Vec[50, -500] 
DEATH_ROTATIONAL_VEL = 360 
RESTART_INTERVAL = 3 
...
DIFFICULTIES = {
  ...
  easy: {
    speed: 180, # pixels/s
    obstacle_gap: 240, # pixels
    obstacle_spawn_interval: 2.0, # secs
  },

  medium: {
    speed: 200, # pixels/s
    obstacle_gap: 200, #pixels
...
class GameWindow < Gosu::Window
  ...
  def initialize(*args)
    ...
    @images = {
      ...
      foreground: Gosu::Image.new(self, 'images/escena.png', true),
      player1: Gosu::Image.new(self, 'images/cata1.png', false),
      player2: Gosu::Image.new(self, 'images/cata2.png', false),
      player3: Gosu::Image.new(self, 'images/cata3.png', false),
      obstacle: Gosu::Image.new(self, 'images/obs.png', false),
      particle: Gosu::Image.new(self, 'images/start.png', false),
    }
...
window = GameWindow.new(320, 414, false)
window.show